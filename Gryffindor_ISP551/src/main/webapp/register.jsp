...
<body>
	...
	<input style="width: 80%; font-size:16px;" type="text" name="username" placeholder="Username">
	</div><br>
	<div>
	<i class="material-icons" style="font-size:25px">email</i>
	<input style="width: 80%; font-size:16px;" type="text" name="email" placeholder="Email">
	</div><br>
	<div>
	<i class="material-icons" style="font-size:25px">lock_outline</i>
	<input style="width: 80%; font-size:16px;" class="input100" type="password" name="password" placeholder="Password">
	</div><br>
	<div>
	<i class="material-icons" style="font-size:25px">lock_open</i>
	<input style="width: 80%; font-size:16px;" class="input100" type="password" name="Cpassword" placeholder="Confirm Password">
	</div><br>
	<%=(request.getAttribute("errMessage") == null) ? ""
         : request.getAttribute("errMessage")%> <br>
	<div><center>
