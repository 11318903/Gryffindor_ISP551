...
<body>
    ...
    <h1>PRODUCT</h1>
    <div id="radios" align="center" class="header"><b>
        
        <input style="display:none" id="rad1" type="radio" name="radioBtn" onclick="changeContent1();" value="1" checked>
        <label class="labels" for="rad1">ADD</label>
        
        <input style="display:none" id="rad2" type="radio" name="radioBtn" onclick="changeContent2();" value="2" >
        <label class="labels" for="rad2">LIST</label>
        
        <input style="display:none" id="rad3" type="radio" name="radioBtn" onclick="changeContent3();" value="3" >
			...
			<form class="myForm" action="AddProductServlet" method="Post">
			    ...
			    <div class="row">
			      <div id="left" class="width-6 container-padding">
					...
					<p>
			          <label>Product Details
			            <textarea name="pDesc" id="" cols="5" rows="3" placeholder="Insert description" required></textarea>
			          </label>
			        </p>
			        <br><br>
			      ...
			      <div class="width-6 container-padding">
			        ...
			        <p>
			          <label>Image
			              <input type="file" id="myFile" name="pPics">
			          </label>
			        </p>
          ...
          <br>
            <table style="width:100%">
                ...
                <%
					...
					<td><a href="readProduct.jsp?pID=<%=resultSet.getString("pID")%>"><%=resultSet.getString("pName") %></td>
					<td><%=resultSet.getString("price") %></td>
					<td><%=resultSet.getString("pQty") %></td>
					<td><a href="update.jsp?pID=<%=resultSet.getString("pID") %>"><button type="button" class="edit">Edit</button></a></td>
					</tr>
					<%
					}
					connection.close();
          ...
          <br>
            <table style="width:100%">
				...
				%>
					...
					<td><%=resultSet.getString("price") %></td>
					<td><%=resultSet.getString("pQty") %></td>
					<td><a href="deleteProduct.jsp?id=<%=resultSet.getString("pID") %>"><button type="button" class="delete" onclick="return confirm('Are you sure you want to delete this item?');">Delete</button></a></td>
					</tr>
				<%
					}
					connection.close();
