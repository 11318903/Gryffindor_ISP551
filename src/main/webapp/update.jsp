...
<p>
	<label>Product Description
		<input type="text" name="pDesc" value="<%=resultSet.getString("pDesc") %>" >
	</label>
</p>
<p>
	<label>Price: RM 
...
<p>
	<label>Quantity 
		<input type="number" name="pQty" value="<%=resultSet.getString("pQty") %>" >
	</label>
</p>  
<center>
<button onCLick="myFunction()">Back</button><input type="submit" value="Submit">
</center></div>
</form>
<%
}
